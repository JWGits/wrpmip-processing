...
def main():
    # initialize dask mpi
    initialize(interface='ib0', nthreads=1, memory_limit='3G', worker_class='distributed.Worker', local_directory='/tmp/dask_scratch', exit=False)
    ...
    with Client() as client:
        ...
        wait(L6)
        # # copy elm b2 to b1
        # dir_in = '/scratch/jw2636/processed_outputs/ELM1-ECA/b2/'
        # dir_out = '/scratch/jw2636/processed_outputs/ELM1-ECA/b1/'
